...
import { getFontSize } from 'regen-components/lib/theme/sizing';
import Title from 'regen-components/lib/components/title';
import ProjectPlaceInfo from 'regen-components/lib/components/place/ProjectPlaceInfo';
import ProjectDeveloperCard from 'regen-components/lib/components/cards/ProjectDeveloperCard';
import ImpactCard from 'regen-components/lib/components/cards/ImpactCard';
import GlanceCard from 'regen-components/lib/components/cards/GlanceCard';
import Description from 'regen-components/lib/components/description';
// import Action from 'regen-components/lib/components/action';
import Timeline from 'regen-components/lib/components/timeline';
import ReadMore from 'regen-components/lib/components/read-more';
import CreditDetails from 'regen-components/lib/components/credits/CreditDetails';
import CreditsGauge from 'regen-components/lib/components/credits/CreditsGauge';
import ProtectedSpecies from 'regen-components/lib/components/sliders/ProtectedSpecies';
import NonMonitoredImpact from 'regen-components/lib/components/sliders/NonMonitoredImpact';
import LandManagementActions from 'regen-components/lib/components/sliders/LandManagementActions';
import ProjectMedia, { Media } from 'regen-components/lib/components/sliders/ProjectMedia';
import Map from 'regen-components/lib/components/map';
...
import BuyFooter from 'regen-components/lib/components/fixed-footer/BuyFooter';
import MrvTabs from 'regen-components/lib/components/tabs';
import Table from 'regen-components/lib/components/table';
import Modal from 'regen-components/lib/components/modal';
import MoreInfoForm from 'regen-components/lib/components/form/MoreInfoForm';
import CreditsPurchaseForm from './CreditsPurchaseForm';
import Banner from 'regen-components/lib/components/banner';
import FixedFooter from 'regen-components/lib/components/fixed-footer';
import ContainedButton from 'regen-components/lib/components/buttons/ContainedButton';
import EmailIcon from 'regen-components/lib/components/icons/EmailIcon';
