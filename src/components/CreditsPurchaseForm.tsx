...
import CheckboxLabel from 'regen-components/lib/components/inputs/CheckboxLabel';
import TextField from 'regen-components/lib/components/inputs/TextField';
import NumberTextField from 'regen-components/lib/components/inputs/NumberTextField';
import SelectTextField, { Option } from 'regen-components/lib/components/inputs/SelectTextField';
import { CreditPrice } from 'regen-components/lib/components/buy-footer';
import {
  requiredMessage,
  validateEmail,
  invalidEmailMessage,
} from 'regen-components/lib/components/inputs/validation';
import Submit from 'regen-components/lib/components/form/Submit';
